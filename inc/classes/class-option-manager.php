...
class Option_Manager {
	...
	public function get_option( $str = '' ) {
		 ...
		 */
		$get_option = get_option( WPMYADMINBAR_PLUGIN_NAME . $str );
	...
	public function get_site_option( $str = '' ) {
		 ...
		 */
		$get_option = get_site_option( WPMYADMINBAR_PLUGIN_NAME . $str );
	...
	public function delete_option( $str = '' ) {
		...
		if ( true === isset( $get_option ) ) {
			 ...
			 */
			delete_option( WPMYADMINBAR_PLUGIN_NAME . $str );
		}
	}//end delete_option()
	...
	public function delete_site_option( $str = '' ) {
		...
		if ( true === isset( $get_option ) ) {
			 ...
			 */
			delete_site_option( WPMYADMINBAR_PLUGIN_NAME . $str );
		}
