...
<div class="postbox">
    ...
    <div class="inside">
        ...
        <li>&bull; <a href="https://github.com/tribalNerd/wp-my-admin-bar" target="_blank"><?php _e('Plugin at GitHub', 'WPMyAdminBar');?></a> and <a href="http://wordpress.org/extend/plugins/wp-my-admin-bar/" target="_blank"><?php _e('Plugin at Wordpress.org', 'WPMyAdminBar');?></a></li>
        <li>&bull; <a href="http://technerdia.com/feedback.html" target="_blank"><?php _e('Contact Form', 'WPMyAdminBar');?></a> : <?php _e('Send Me Feedback.', 'WPMyAdminBar');?></li>
        <li>&bull; <a href="https://github.com/tribalNerd/wp-my-admin-bar/issues" target="_blank"><?php _e('Report Bugs and Issues.', 'WPMyAdminBar');?></a></li>
        </ul>
    </div>
</div>
